...
import LandAbi from './artifacts/src/contracts/Land.sol/Land.json';
import LandAddress from './artifacts/src/contracts/Land.sol/Land_address.json'
...
function App() {
  ...
  const loadBlockchainData = async () => {
    if (typeof window.ethereum !== 'undefined') {
      ...
      const land = new web3.eth.Contract(LandAbi.abi, LandAddress.address)
